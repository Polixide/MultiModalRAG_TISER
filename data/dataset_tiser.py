...
SYSTEM_MESSAGE = (
    ...
    "reasoning required, go back to Step 1. "
                ...
                "content": [
                    {"type": "image"},
                    {
                        ...
                        "text": (
                            ...
                            "for this question. Important: Use the chart to reason about the order, "
                            "overlap and duration of events, and answer exactly what is asked in the "
                            "question. When the question asks about a specific date or date range, "
                            "identify the event whose interval actually includes that date or fully "
                            "covers that range. If the chart does not provide enough information to "
